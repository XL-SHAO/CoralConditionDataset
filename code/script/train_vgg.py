...
import time
from torchvision.models import vgg16_bn, vgg13_bn, vgg19_bn, VGG16_BN_Weights, VGG13_BN_Weights, VGG19_BN_Weights
...
class Trainer(object):
    def __init__(self, args):
        ...
        self.model = vgg13_bn(weights=VGG13_BN_Weights.IMAGENET1K_V1)
        in_features = self.model.classifier[-1].in_features

        # Replace the last layer with a new one with the desired number of output classes
        self.model.classifier[-1] = torch.nn.Linear(in_features, 8)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_save_path', type=str,
                        default='/home/songjian/project/CRC/saved_model/VGG13')
