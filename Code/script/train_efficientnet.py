...
class Trainer(object):
    def __init__(self, args):
        ...
        self.model = EfficientNet.from_pretrained('efficientnet-b7')  # models.resnet34(pretrained=True)
        num_ftrs = self.model._fc.in_features
        # self.model = models.EfficientNet(pretrained=True)
        # num_ftrs = self.model.fc.in_features

        # Replace the final fully connected layer
        # Here, 8 is the number of output classes
        self.model._fc = nn.Linear(num_ftrs, 8)
        self.model.cuda()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_save_path', type=str,
                        default='/home/songjian/project/CRC/saved_model/EfficientNetB7')
