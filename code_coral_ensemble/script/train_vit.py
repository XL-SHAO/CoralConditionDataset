...
class Trainer(object):
    def __init__(self, args):
        ...
        self.model.heads[-1] = torch.nn.Linear(num_ftrs, 8)
        self.model.cuda()

        self.optimizer = AdamW(self.model.parameters(), lr=6e-5, weight_decay=5e-3)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_save_path', type=str,
                        default='/home/songjian/project/CRC/saved_model/ViT')
