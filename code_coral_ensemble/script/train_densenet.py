...
import time
from torchvision.models import densenet121, densenet161, densenet201, DenseNet121_Weights, DenseNet161_Weights, DenseNet201_Weights
...
class Trainer(object):
    def __init__(self, args):
        ...
        self.model.classifier = torch.nn.Linear(in_features, 8)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_save_path', type=str,
                        default='/home/songjian/project/CRC/saved_model/DenseNet201')
